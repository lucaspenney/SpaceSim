var LZString = {
    ...
    _compress: function(r, e, n) {
            ...
            if (p = r[i], Object.prototype.hasOwnProperty.call(s, p) || (s[p] = f++, a[p] = !0), u = c + p, Object.prototype.hasOwnProperty.call(s, u)) c = u;
                ...
                if (Object.prototype.hasOwnProperty.call(a, c)) {
                    if (c.charCodeAt(0) < 256) {
                        for (o = 0; h > o; o++) g <<= 1, S == e - 1 ? (S = 0, d.push(n(g)), g = 0) : S++;
                        for (t = c.charCodeAt(0), o = 0; 8 > o; o++) g = g << 1 | 1 & t, S == e - 1 ? (S = 0, d.push(n(g)), g = 0) : S++, t >>= 1
                    } else {
                        for (t = 1, o = 0; h > o; o++) g = g << 1 | t, S == e - 1 ? (S = 0, d.push(n(g)), g = 0) : S++, t = 0;
                        for (t = c.charCodeAt(0), o = 0; 16 > o; o++) g = g << 1 | 1 & t, S == e - 1 ? (S = 0, d.push(n(g)), g = 0) : S++, t >>= 1
                    }
                    l--, 0 == l && (l = Math.pow(2, h), h++), delete a[c]
                } else
                    for (t = s[c], o = 0; h > o; o++) g = g << 1 | 1 & t, S == e - 1 ? (S = 0, d.push(n(g)), g = 0) : S++, t >>= 1;
        ...
        for (t = 2, o = 0; h > o; o++) g = g << 1 | 1 & t, S == e - 1 ? (S = 0, d.push(n(g)), g = 0) : S++, t >>= 1;
        for (;;) {
            if (g <<= 1, S == e - 1) {
                d.push(n(g));
                break
    ...
    _decompress: function(r, e, n) {
        ...
        for (l[3] = c, i = c, S.push(c);;) {
            if (v.index > r) return "";
            for (s = 0, p = Math.pow(2, d), u = 1; u != p;) a = v.val & v.position, v.position >>= 1, 0 == v.position && (v.position = e, v.val = n(v.index++)), s |= (a > 0 ? 1 : 0) * u, u <<= 1;
            switch (c = s) {
                case 0:
                    for (s = 0, p = Math.pow(2, 8), u = 1; u != p;) a = v.val & v.position, v.position >>= 1, 0 == v.position && (v.position = e, v.val = n(v.index++)), s |= (a > 0 ? 1 : 0) * u, u <<= 1;
                    l[h++] = m(s), c = h - 1, f--;
            ...
            if (0 == f && (f = Math.pow(2, d), d++), l[c]) g = l[c];
            else {
                if (c !== h) return null;
                g = i + i[0]
            }
            S.push(g), l[h++] = i + g[0], f--, i = g, 0 == f && (f = Math.pow(2, d), d++)
        }
    }
};
